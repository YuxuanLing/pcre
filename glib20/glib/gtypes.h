 ...
 */
#if defined (__GNUC__) && (__GNUC__ >= 2) && defined (__OPTIMIZE__) && !defined (__llvm__)
#  if defined (__i386__)
...
#      define GLIB_VAR_64 GLIB_VAR
#    else /* !GLIB_STATIC_COMPILATION */
#      ifdef GLIB_COMPILATION
#        ifdef DLL_EXPORT
#          define GLIB_VAR __declspec(dllexport)
#          define GLIB_VAR_64 extern
#        else /* !DLL_EXPORT */
#          define GLIB_VAR extern
#          define GLIB_VAR_64 GLIB_VAR
#        endif /* !DLL_EXPORT */
...
#    if (defined(__SUNPRO_C) && (__SUNPRO_C >= 0x590)) || (defined(__GNUC__) && !defined(__INTEL_COMPILER))
#      define GLIB_VAR extern __attribute__ ((visibility ("default")))
#    else
#      define GLIB_VAR extern
#    endif
