...
#ifdef _WIN64
GLIB_VAR_64 GThreadFunctions       g_thread_functions_for_glib_use;
GLIB_VAR_64 gboolean               g_thread_use_default_impl;
GLIB_VAR_64 gboolean               g_threads_got_initialized;
GLIB_VAR_64 guint64                (*g_thread_gettime) (void);
#else
