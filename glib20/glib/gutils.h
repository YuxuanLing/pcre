 ...
 */
#ifdef _WIN64
GLIB_VAR_64 const guint glib_major_version;
GLIB_VAR_64 const guint glib_minor_version;
GLIB_VAR_64 const guint glib_micro_version;
GLIB_VAR_64 const guint glib_interface_age;
GLIB_VAR_64 const guint glib_binary_age;
#else
